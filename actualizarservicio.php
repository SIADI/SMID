...
$sql = "select * from servicios where id='$zz'";
$query=$z->query($sql);
...
<form name="form1" method="post" action="2actualizarservicio.php">
  ...
  <table width="200" border="1">
	...
	<tr>
      <td>arreglo: </td>
      <td><input type="text" name="arreglo" id="arreglo" value="<?php echo $res['arreglo'];?>"></td>
    </tr>
    <tr>
      <td>costo:</td>
		<td><input type="text" name="costo" nombre="costo" value="<?php echo $res['costo'];?>"></td>
    </tr>
    
    <tr>
      <td><label for="numero">repuesto: </label></td>
      <td><input type="text" name="repuesto" id="repuesto" value="<?php echo $res['repuesto'];  ?>" ></td>
    </tr>
    <tr>
      <td><label for="carro">ejecutor: </label></td>
      <td><input type="text" name="ejecutor" id="ejecutor" value="<?php echo $res['ejecutor'];  ?>" ></td>
    </tr>
	<!--<tr>
      <td>placa: </td>
...
<p><a href="menuservicios.html">Volver menu principal</a></p>
<br><br><br>
					</header>
